...
#define i2c_cam_addr 0x78 //0x10


#define dev_ID_h_  0x56
#define dev_ID_l_  0x40
...
int PiCam_init(int default_exposure);
...
struct config_word_t { uint16_t addr; uint8_t data; } ;
//struct config_awb_t { int awb; struct config_word_t const* cfg; size_t cfg_size; } ;


#define OV5640_REG_PRE_ISP_TEST_SET1 0x503D;
#define OV5640_FORMAT_MUX_CONTROL 0x501f;
